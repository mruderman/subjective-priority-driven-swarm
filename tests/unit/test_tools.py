...
class TestPerformSubjectiveAssessment:
    ...
    def test_assessment_with_expertise_keywords(self):
        ...
        topic = "Testing Strategy"
        conversation_history = "We need comprehensive testing and validation of our system."
        agent_persona = "A testing expert"
    ...
    def test_assessment_with_urgency_keywords(self):
        ...
        topic = "Critical Bug"
        conversation_history = "This is urgent! We need to fix this critical issue immediately."
    ...
    def test_assessment_with_questions(self):
        ...
        conversation_history = "How should we implement this feature? What are the best practices?"
    ...
    def test_assessment_without_expertise_match(self):
        ...
        conversation_history = "We need to plan our marketing campaign for next quarter."
    ...
    def test_assessment_with_long_conversation(self):
        ...
        assert all(0 <= score <= 10 for score in [
