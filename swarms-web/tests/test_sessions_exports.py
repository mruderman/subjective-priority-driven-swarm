...
def test_session(tmp_path):
    ...
    events = [
        ...
        SessionEvent(
            ...
            actor="test_agent",
            type="decision",
            payload={"decision_type": "test_decision", "details": {"outcome": "approved"}}
        )
    ]
...
class TestSessionExports:
    ...
    def test_trigger_export_success(self, client, test_session):
        ...
        response = client.post(f'/api/sessions/{test_session}/export', 
    ...
    def test_trigger_export_invalid_session(self, client):
        ...
        invalid_session_id = "non-existent-session-id"
        response = client.post(f'/api/sessions/{invalid_session_id}/export', 
                              content_type='application/json')
    ...
    def test_download_export_invalid_filename(self, client, test_session):
        ...
        response = client.get(f'/api/sessions/{test_session}/exports/{invalid_filename}')
    ...
    def test_download_export_path_traversal(self, client, test_session):
        ...
        response = client.get(f'/api/sessions/{test_session}/exports/{malicious_filename}')
    ...
    def test_download_export_nonexistent_file(self, client, test_session):
        ...
        response = client.get(f'/api/sessions/{test_session}/exports/{nonexistent_filename}')
    ...
    def test_export_file_content_validation(self, client, test_session):
        ...
        json_export = next(item for item in data['created'] if item['kind'] == 'json')
        response = client.get(f'/api/sessions/{test_session}/exports/{json_export["filename"]}')
        ...
        md_export = next(item for item in data['created'] if item['kind'] == 'markdown')
        response = client.get(f'/api/sessions/{test_session}/exports/{md_export["filename"]}')
