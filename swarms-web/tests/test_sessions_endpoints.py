...
def test_create_session_minimal(client, temp_sessions_dir):
    ...
    response = client.post("/api/sessions", json={}, content_type="application/json")
...
def test_create_session_with_title_and_tags(client, temp_sessions_dir):
    ...
    payload = {"title": "Test Session", "tags": ["test", "demo"]}

    response = client.post(
        "/api/sessions", json=payload, content_type="application/json"
    )
...
def test_create_session_invalid_json(client, temp_sessions_dir):
    ...
    response = client.post(
        "/api/sessions", data="invalid json", content_type="application/json"
    )
...
def test_resume_session_success(client, temp_sessions_dir):
    ...
    create_response = client.post(
        "/api/sessions", json={"title": "Test Session"}, content_type="application/json"
    )
    ...
    response = client.post(
        "/api/sessions/resume", json={"id": session_id}, content_type="application/json"
    )
...
def test_resume_session_missing_id(client, temp_sessions_dir):
    ...
    response = client.post(
        "/api/sessions/resume", json={}, content_type="application/json"
    )
...
def test_resume_session_invalid_json(client, temp_sessions_dir):
    ...
    response = client.post(
        "/api/sessions/resume", data="invalid json", content_type="application/json"
    )
...
def test_get_sessions_sorted_by_last_updated(client, temp_sessions_dir):
    ...
    for title in ["First", "Second", "Third"]:
        response = client.post(
            "/api/sessions", json={"title": title}, content_type="application/json"
        )
        assert response.status_code == 201
...
def test_session_data_format(client, temp_sessions_dir):
    ...
    response = client.post(
        "/api/sessions",
        json={"title": "Test Session", "tags": ["test", "demo"]},
        content_type="application/json",
    )
