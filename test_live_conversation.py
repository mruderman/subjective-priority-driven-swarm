        ...
        for round_num in range(3):
            ...
            motivated_agents = sorted(
                [
                    agent
                    for agent in swarm.agents
                    if agent.motivation_score >= config.PARTICIPATION_THRESHOLD
                ],
            ...
            if speaker.last_assessment:
                print(f"\n📈 Assessment Details:")
                print(
                    f"   - Importance to self: {speaker.last_assessment.importance_to_self}"
                )
                print(
                    f"   - Expertise relevance: {speaker.last_assessment.expertise_relevance}"
                )
                print(
                    f"   - Unique perspective: {speaker.last_assessment.unique_perspective}"
                )
